<template>
    ...
    <el-dialog v-model="dialogVisible" title="新建入库单" width="500" :before-close="handleClose">
        ...
        >
        <el-form-item label="材料名称" prop="wuliaoname" :rules="[{
    ...
    >
            ...
            <el-form-item label="出库数量" prop="chukunum" :rules="[{
     required:true, message:'此项为必填', trigger:'blur'}]">
                <el-input v-model="chukuinfo.subinfo.chukunum"></el-input>
            </el-form-item>
            <el-form-item label="领料人" prop="type" :rules="[{
     required:true, message:'此项为必填', trigger:'blur'}]">
                <el-input v-model="chukuinfo.subinfo.type"></el-input>
            </el-form-item>
            <el-form-item label="所需项目" prop="object" :rules="[{
     required:true, message:'此项为必填', trigger:'blur'}]" >
        ...
        <template #footer>
            <div class="dialog-footer">
                ...
                <el-button type="primary" @click="pushArray">
                    提交
                </el-button>
            </div>
        </template>
